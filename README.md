...
[![Latest release](https://img.shields.io/github/v/release/chrplr/leadingedge-go)](https://github.com/chrplr/leadingedge-go/releases/latest)
...
|--------|----------|---------|
| Steer  | Left / Right | D-pad, or left stick (proportional) |
| Accelerate | Ctrl, Z, Space, or Enter | A |
| Brake  | Shift or X | B |
| Start  | any Accelerate key | A |
| End race | Esc | — |
